    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="color: #ffffff;">My Haulage Requests<span class="caret"></span><span style="font-size:16px;" class="pull-right hidden-xs showopacity fa fa-newspaper-o"></span></a>
                    <ul class="dropdown-menu forAnimate" role="menu">
                        <li><a href="{{url('/viewRequests')}}">View All Requests</a></li>
                    </ul>
                </li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu forAnimate" role="menu">
                        <li><a href="{{ url('/home') }}">View All Resources</a></li>
                    </ul>
                </li>
            </ul>
        </div>
...
<div class="main" style="background-color: #0c0b0b08;">
    ...
    <div class="container-fluid">
        <div class="page_header">
            <div> <h2 class="title"> <i class="fa fa-thumb-tack" aria-hidden="true"></i> My Resources </h2>  </div>
        </div>
            ...
            <div class="col-md-11 ">
                <div class="table-responsive">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                        @forelse($myResources as $allRequest)
                        <tr class="row-content">
                            <td><h5>{{$allRequest->resource_id}}</h5></td>
                            <td><h5>@if($allRequest->resourceType == 0)
                                    Truck
                                    @elseif($allRequest->resourceType == 1)
                                    Ship
                                    @elseif($allRequest->resourceType == 2)
                                    Cargo Plane
                                    @endif
                            </h5></td>
                            <td><h5>{{$allRequest->capacity}}</h5></td>
                            <td>
                                <h5>{{$allRequest->origin}}</h5>
                            </td>
                            <td>
                                <h5>{{$allRequest->destination}}</h5>
                            </td>
                            <td>
                                <h5>{{$allRequest->price}}</h5>
                            </td>
                            <td><h5>
                                    @if($allRequest->resourceStatus == 0)
                                    Available
                                    @elseif($allRequest->resourceStatus == 1)
                                    In Use
                                    @elseif($allRequest->resourceStatus == 2)
                                    Inactive
                                    @elseif($allRequest->resourceStatus == 3)
                                    Under Maintenance
                                    @endif
                            </h5></td>
                        </tr>
