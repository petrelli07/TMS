    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="color: #ffffff;">Order Management<span class="caret"></span><span style="font-size:16px;" class="pull-right hidden-xs showopacity fa fa-newspaper-o"></span></a>
...
<div class="main" style="background-color: #0c0b0b08;">
    ...
    <div class="container-fluid">
        <div class="page_header">
            <div> <h2 class="title"> <i class="fa fa-thumb-tack" aria-hidden="true"></i> My Orders </h2>  </div>
            <div class="add_new_post">
                <a href="{{url('/home')}}"><i class="fa fa-plus" aria-hidden="true"></i> New Order </a>
            </div>
        </div>

        <div class="post_details">
            <div class="overview_text" >
                <div><h6> All My Orders( {{$countRequests}} )</h6></div>
                        ...
                        <tr class="row-content">
                            ...
                            <td>
                                    <h5>
                                        ...
                                        Invoice Created (Awaiting Your Approval)
                            ...
                            <td>
                                @if($allRequest->orderStatus == 0)
                                <a class="btn btn-info edit" href='#' title="Edit Order Details">
                                    Edit Order Details    <i class="fa fa-pencil" aria-hidden="true"></i>
                                </a>|<a class="btn btn-success edit" href='{{ url("/viewOrderDetails/{$allRequest->serviceIDNo}") }}' title="View Order Details">
                                    View Order Details  <i class="fa fa-eye" aria-hidden="true"></i>
                                </a>
                                @elseif($allRequest->orderStatus == 1)
                                Review Passed
                                @elseif($allRequest->orderStatus == 2)
                                <a class="btn btn-success edit" href='{{ url("/approveInvoice/{$allRequest->serviceIDNo}") }}' title="View Invoice Details">
                                    View Invoice Details   <i class="fa fa-check-circle" aria-hidden="true"></i>
                                </a>
                                @elseif($allRequest->orderStatus == 3)
                                <a class="btn btn-success edit" href='{{ url("/viewInvoice/{$allRequest->serviceIDNo}") }}' title="View Invoice Details">
                                ...
                                @elseif($allRequest->orderStatus == 4)
                                <a class="btn btn-success edit" href='{{ url("/viewInvoice/{$allRequest->serviceIDNo}") }}' title="View Details">
                                 View Invoice Details   <i class="fa fa-eye" aria-hidden="true"></i>
                                </a>|
                                <a class="btn btn-success edit" href='{{ url("/viewInvoice/{$allRequest->serviceIDNo}") }}' title="View Invoice Details">
                                    <i class="fa fa-eye" aria-hidden="true"></i>
                                </a>
                                ...
                                @elseIf($allRequest->orderStatus == 6)
                                <a class="btn btn-success edit" href='{{ url("/finishTransaction/{$allRequest->serviceIDNo}") }}' title="Finish Transaction">
                                    <i class="fa fa-chevron-circle-right" aria-hidden="true"></i>
                                </a>|
                                <a class="btn btn-success edit" href='{{ url("/openDispute/{$allRequest->serviceIDNo}") }}' title="View Details">
