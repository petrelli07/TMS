                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-striped">
                        ...
                        <tr class="row-content">
                            <td><h5>{{$resources->name}}</h5></td>
                            <td><h5>{{$resources->email}}</h5></td>
                            <td><h5>
                                    @if($resources->userAccessLevel == 0)
                                    Admin
                                    @elseif($resources->userAccessLevel == 1)
                                    Client
                                    @elseif($resources->userAccessLevel == 2)
                                    Carrier
                                    @endif
                                </h5></td>
                        </tr>
